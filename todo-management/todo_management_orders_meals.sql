...
CREATE TABLE `orders_meals` (
  ...
  KEY `FK541mtro4q32calvqycapqnl3w` (`meal_id`),
  CONSTRAINT `FK23en38xrrkiiv78l1tlx7fu1l` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`),
  CONSTRAINT `FK541mtro4q32calvqycapqnl3w` FOREIGN KEY (`meal_id`) REFERENCES `meals` (`id`)
...
INSERT INTO `orders_meals` VALUES (4,1),(4,2),(4,3);
